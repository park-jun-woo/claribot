...
4. **Report**: 분석 보고서 (completed 상태, response 있을 때)
   - Markdown 렌더링으로 표시
   - `.claritask/complete` 파일 내용이 DB response 필드에 저장됨
...
├─────────────────────────────────────────┤
│ ## 분석 요약                             │
│ 사용자 요청을 분석하여 다음 Task를 생성   │
│                                         │
│ ## 생성된 Task 목록                      │
│ - Task #42: 로그인 에러 메시지 개선       │
│ - Task #43: 에러 코드별 메시지 분류       │
│                                         │
│ ## 참고 사항                             │
│ - FDL 기반으로 구현 예정                  │
└─────────────────────────────────────────┘
